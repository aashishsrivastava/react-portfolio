          ...
          <div className="w-full  lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
              <motion.h1
                ...
                initial="hidden"
                animate="visible"
                className="pb-16 text-6xl text-center font-thin tracking-tighter lg:mt-16  lg:text-7xl"
              >
                Ashish Kumar <br /> Srivastava
              </motion.h1>
              <motion.span
          ...
          <div className="w-full lg:w-1/2 lg:p-8 ">
            <div className="flex justify-center ">
              <motion.img
                ...
                src={profilepic}
                alt="Ashish Kumar Srivastava Profile Image"
